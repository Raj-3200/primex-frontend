  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border shadow-sm p-6">
        <h2 className="text-lg font-semibold mb-4">Tank Jobs <span className="text-xs font-normal text-muted-foreground">(includes combined contracts)</span></h2>
            ...
            <TableBody>
              {orders.map((order) => (
                <TableRow key={order.id}>
                  ...
                  <TableCell>
                    {order.scheduled_date ? formatSchedule(order.scheduled_date, order.scheduled_time) : '—'}
                  </TableCell>
